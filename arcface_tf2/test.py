...
flags.DEFINE_string('cfg_path', r'c:/users/mrdas/documents/cynapto_folder/merged/arcface_tf2/configs/arc_res50.yaml', 'config file path')
...
def main(_argv):
    ...
    ckpt_path = tf.train.latest_checkpoint(r"C:\Users\mrdas\Documents\cynapto_folder\datasets\arc_res50\arc_res50")
